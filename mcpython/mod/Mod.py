...
class Mod:
    def __init__(self, name: str, version: typing.Tuple[int, ...]):
        ...
        self.event_handler.register_event_type(
            "mod-loading:dependency_scan_failed:total"
        )
        ...
        self.event_handler.register_event_type(
            "mod-loading:all_dependency_checks_success"
        )
    ...
    def add_dependency(
        self,
        name: str,
        version_checker: typing.Callable[
            [typing.Tuple[int, ...]], bool
        ] = lambda _: True,
    ):
        pass

    def add_incompatible(
        self,
        name: str,
        version_checker: typing.Callable[
            [typing.Tuple[int, ...]], bool
    ...
    def add_load_if_not_present_dependency(
        self,
        name: str,
        version_checker: typing.Callable[
            [typing.Tuple[int, ...]], bool
